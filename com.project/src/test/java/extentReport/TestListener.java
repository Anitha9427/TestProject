...
public class TestListener extends BaseClass implements ITestListener {        //listeners are used to monitor and act on specific events that occur during test execution.
																			 //You can use listeners in Selenium to integrate Extent Reports for better test logging, monitoring, and reporting.
    // Extent Report Declarations 											Listeners in combination with Extent Reports enable capturing test events such as start, success, failure, or skip and logging them into the report dynamically.
